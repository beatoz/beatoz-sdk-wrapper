...
export abstract class BaseErc20Client extends BeatozContract {
    ...
    async transferFrom(signer: BeatozAccount, fromAddress: string, toAddress: string, amount: string, gas: number = DEFAULT_GAS) {
    ...
    async approve(fromAccount: BeatozAccount, spender: string, amount: string, gas: number = DEFAULT_GAS) {
    ...
    async transfer(fromAccount: BeatozAccount, toAddress: string, amount: string, gas: number = DEFAULT_GAS) {
